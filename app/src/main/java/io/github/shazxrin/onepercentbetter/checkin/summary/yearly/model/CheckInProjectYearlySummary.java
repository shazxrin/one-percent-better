...
@Table(name = "check_in_project_yearly_summaries")
@Entity
public class CheckInProjectYearlySummary {
    @Id
    ...
    public CheckInProjectYearlySummary(int year, LocalDate startDate, LocalDate endDate, int noOfCheckIns, int streak, Project project) {
        this();
        this.year = year;
    ...
    public CheckInProjectYearlySummary() {
