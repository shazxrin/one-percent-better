package io.github.shazxrin.onepercentbetter.checkin.summary.monthly.model;
...
@Table(name = "check_in_project_aggregate_monthly_summaries")
@Entity
public class CheckInProjectAggregateMonthlySummary {
    @Id
    ...
    public CheckInProjectAggregateMonthlySummary(
        int year,
        int monthNo,
        LocalDate startDate,
        LocalDate endDate,
