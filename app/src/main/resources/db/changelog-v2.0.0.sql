...
-- changeset rin:1754230033248-10
ALTER TABLE check_in_project_daily_summaries
    ADD CONSTRAINT uc_check_in_project_daily_summaries_date UNIQUE (date);

-- changeset rin:1754230033248-11
ALTER TABLE check_in_habits
    ADD CONSTRAINT FK_CHECK_IN_HABITS_ON_HABIT FOREIGN KEY (habit_id) REFERENCES habits (id);

-- changeset rin:1754230033248-12
